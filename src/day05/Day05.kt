...
private const val PATH_RESOURCES = "day05/resources"
...
fun main() {
    ...
    val result01 = part1(readInput("$PATH_RESOURCES/Day05_01_01"))
    check(result01 == 143)

    val result02 = part1(readInput("$PATH_RESOURCES/Day05_01_02"))
    check(result02 == 5166)

    // Test if implementation meets criteria for Part02:
    val result03 = part2(readInput("$PATH_RESOURCES/Day05_02_01"))
    check(result03 == 123)

    val result04 = part2(readInput("$PATH_RESOURCES/Day05_02_02"))
    check(result04 == 4679)
