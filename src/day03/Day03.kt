...
private const val PATH_RESOURCES = "day03/resources"
...
fun main() {
    ...
    val result01 = part1(readInput("$PATH_RESOURCES/Day03_01_01"))
    check(result01 == 161)

    val result02 = part1(readInput("$PATH_RESOURCES/Day03_01_02"))
    check(result02 == 187825547)

    // Test if implementation meets criteria for Part02:
    val result03 = part2(readInput("$PATH_RESOURCES/Day03_02_01"))
    check(result03 == 48)

    val result04 = part2(readInput("$PATH_RESOURCES/Day03_02_02"))
